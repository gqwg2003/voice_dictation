...
template <> constexpr inline auto AudioProcessor::qt_create_metaobjectdata<qt_meta_tag_ZN14AudioProcessorE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Signal 'audioLevelsChanged'
        QtMocHelpers::SignalData<void(const std::vector<float> &)>(4, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 5, 6 },
        }}),
        // Signal 'audioDataReady'
        QtMocHelpers::SignalData<void(const std::vector<float> &)>(7, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 5, 8 },
        }}),
...
void AudioProcessor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->audioLevelsChanged((*reinterpret_cast< std::add_pointer_t<std::vector<float>>>(_a[1]))); break;
        case 3: _t->audioDataReady((*reinterpret_cast< std::add_pointer_t<std::vector<float>>>(_a[1]))); break;
        case 4: _t->errorOccurred((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 5: _t->processAudioInput(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (AudioProcessor::*)()>(_a, &AudioProcessor::recordingStarted, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (AudioProcessor::*)()>(_a, &AudioProcessor::recordingStopped, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (AudioProcessor::*)(const std::vector<float> & )>(_a, &AudioProcessor::audioLevelsChanged, 2))
            return;
        if (QtMocHelpers::indexOfMethod<void (AudioProcessor::*)(const std::vector<float> & )>(_a, &AudioProcessor::audioDataReady, 3))
            return;
        if (QtMocHelpers::indexOfMethod<void (AudioProcessor::*)(const QString & )>(_a, &AudioProcessor::errorOccurred, 4))
            return;
    }
}
...
// SIGNAL 0
void AudioProcessor::recordingStarted()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void AudioProcessor::recordingStopped()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void AudioProcessor::audioLevelsChanged(const std::vector<float> & _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 2, nullptr, _t1);
}

// SIGNAL 3
void AudioProcessor::audioDataReady(const std::vector<float> & _t1)
{
